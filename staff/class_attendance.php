    ...
    <div class="wrapper">
        ...
        <script>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-warning btn-sm" onclick="editClass(<?php echo $classData['id'] ?>)">Edit</button>
            ...
            function editClass(classId) {
                ...
                // Set the classId in the hidden input field
                ...
                document.getElementById('editClassForm').addEventListener('submit', function(event) {
                    ...
                    fetch('update_class_status.php', {
                        ...
                        .then(data => {
                            if (data.success) {
                                return Swal.fire('Success!', 'Class status updated successfully!', 'success'); // Return the SweetAlert promise
                            } else {
                                return Swal.fire('Error!', 'Failed to update class status: ' + data.message, 'error');
                            }
                        })
                        .then(() => {
