        ...
        <div class="main">
            <main class="content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="gradingForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="activities"
                                            placeholder="Enter percentage" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="projects"
                                            placeholder="Enter percentage" required>
                                    </div>
                ...
                if ($rubrics) {
                    ...
                    $activitiesPercentage = isset($rubrics['activities']) ? floatval($rubrics['activities']) : 0;
                    $attendancePercentage = isset($rubrics['attendance']) ? floatval($rubrics['attendance']) : 0;
                    $projectsPercentage = isset($rubrics['projects']) ? floatval($rubrics['projects']) : 0;

                    // Total percentage (optional, you can decide how to use this or store)
                    $totalPercentage = $majorExamPercentage + $quizzesPercentage + $activitiesPercentage + $attendancePercentage + $projectsPercentage;

                    // Output or use the variables
                    echo "Major Exam: $majorExamPercentage%\n";
                    echo "Quizzes: $quizzesPercentage%\n";
                    echo "Activities: $activitiesPercentage%\n";
                    echo "Attendance: $attendancePercentage%\n";
                    echo "Projects: $projectsPercentage%\n";
                    echo "Total Percentage: $totalPercentage%\n";

                    // If needed, you can also return the values in a response (JSON or other)
                ...
                <script>
                    ...
                    function submitGrading() {
                        ...
                        // Validate input
                        if (majorExam && quizzes && activities && attendance && projects) {
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="border: 1px solid black;">
                                            ...
                                            <td class="text-center bold"
                                                colspan="<?php echo $data['quiz']['count']; ?>">Quizzes
                                                (<?php echo $quizzesPercentage ?>%)</td>
                                            <td class="text-center bold">Total</td>

                                            <!-- Activities -->
                                            <td class="text-center bold"
                                                colspan="<?php echo $data['activity']['count']; ?>">Activities
                                                (<?php echo $activitiesPercentage ?>%)
                                            </td>
                                            <td class="text-center bold">Total</td>
                                            ...
                                            <!-- Projects -->
                                            <td class="text-center bold"
                                                colspan="<?php echo $data['project']['count']; ?>">Projects
                                                (<?php echo $projectsPercentage ?>%%)</td>
                                            <td class="text-center bold">Total</td>
                                        ...
                                        <tr>
                                            ...
                                            // Loop through the max_points_list dynamically
                                            foreach ($data['quiz']['max_points_list'] as $i => $max_points):
                                                $quizpts += $max_points; ?>
                                                <td class="text-center bold">Q<?php echo $i + 1; ?> <br>
                                                    (<?php echo $max_points; ?>)</td>
                                            <?php endforeach; ?>
                                            <td><?php echo $data['quiz']['total']; ?> </td>
                                                ...
                                                foreach ($activityData as $activityType => $details):
                                                    ...
                                                    if ($activityType == 'quiz') {
                                                        foreach ($scores as $score) {
                                                            ...
                                                            $totalActivityType += $score; // Sum up the total for quiz
                                                        }
                                                        echo "<td class='text-center'>" . $totalActivityType . "</td>";
                                                        $totalQuiz = $totalActivityType;
                                                    }
