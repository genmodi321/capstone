        ...
        <div class="main">
            <main class="content">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="gradingForm">
                                    <div class="mb-3">
                                        <label for="majorExam" class="form-label">Major Exam</label>
                                        <input type="number" class="form-control" id="majorExam"
                                            placeholder="Enter percentage" value="<?php echo $majorExamPercentage; ?>"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="laboratoryExercises" class="form-label">Laboratory Exercises</label>
                                        <input type="number" class="form-control" id="laboratoryExercises"
                                            placeholder="Enter percentage"
                                            value="<?php echo $laboratoryExercisesPercentage; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="assignments" class="form-label">Assignments</label>
                                        <input type="number" class="form-control" id="assignments"
                                            placeholder="Enter percentage" value="<?php echo $assignmentsPercentage; ?>"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="attendance" class="form-label">Attendance</label>
                                        <input type="number" class="form-control" id="attendance"
                                            placeholder="Enter percentage" value="<?php echo $attendancePercentage; ?>"
                                            required>
                                    </div>
                                    <?php
                                    $classId = $_GET['id'];
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" onclick="submitGrading()">Save
                                    Changes</button>
                            </div>
                        </div>
                    </div>
                ...
                if ($rubrics) {
                    ...
                    $laboratoryExercisesPercentage = isset($rubrics['laboratory_exercises']) ? floatval($rubrics['laboratory_exercises']) : 0;
                    $assignmentsPercentage = isset($rubrics['assignments']) ? floatval($rubrics['assignments']) : 0;
                    ...
                    $totalPercentage = $majorExamPercentage + $laboratoryExercisesPercentage + $assignmentsPercentage + $attendancePercentage;

       
                } else {
                    // Default percentages if no rubrics found
                    $majorExamPercentage = 40;
                    $laboratoryExercisesPercentage = 50;
                    $assignmentsPercentage = 5;
                ...
                <script>
                    ...
                    function submitGrading() {
                        ...
                        const laboratoryExercises = document.getElementById("laboratoryExercises").value;
                        const assignments = document.getElementById("assignments").value;
                        const attendance = document.getElementById("attendance").value;
                        const classId = document.getElementById("classId").value;

                        if (majorExam && laboratoryExercises && assignments && attendance) {
                            fetch('laboratory_update_grading.php', {
                                ...
                                body: JSON.stringify({
                                    ...
                                    laboratory_exercises: laboratoryExercises,
...
";
                                ...
                                $attendancePercentage = 5; // Example: attendance is worth 10%
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="border: 1px solid black;">
                                            ...
                                            <td class="text-center bold"
                                                colspan="<?php echo $data['activity']['count']; ?>">Activities
                                                (<?php echo $assignmentsPercentage ?>%)
                                            </td>
                                            <td class="text-center bold">Total</td>

                                            <!-- Attendance -->
                                            <td class="text-center bold">Attendance
                                                (<?php echo $attendancePercentage ?>%)</td>
                                            <td class="text-center bold">Total</td>

                                            <!-- Projects -->
                                            <td class="text-center bold"
                                                colspan="<?php echo $data['project']['count']; ?>">Exercises
                                                (<?php echo $laboratoryExercisesPercentage ?>%)</td>
                                            <td class="text-center bold">Totals <?php echo $data['project']['count']; ?>
                                            </td>

                                            <!-- Exams -->
                                            <td class="text-center bold"
                                                colspan="<?php echo $data['exam']['count']; ?>">Exams
                                                (<?php echo $majorExamPercentage ?>%)</td>
                                            <td class="text-center bold">Total</td>
