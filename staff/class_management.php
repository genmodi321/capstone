                                    ...
                                    <div class="col-md-4">
                                        <div class="card bg-light">
                                            ...
                                            try {
                                                ...
                                                // Fetch all subject_ids for the teacher
                                                $classes_stmt = $pdo->prepare("SELECT subject_id, name FROM classes WHERE teacher = :teacher_name");
                                                ...
                                                if (!$classes) {
                                                    echo '
                                                    <div class="container-fluid alert alert-warning text-center" role="alert" style="margin-top: 20px; font-size: 1.2rem;">
                                                        <strong>No classes found!</strong> It looks like this teacher hasn\'t been assigned any classes yet.
                                                    </div>';
                                                    exit;
                                                }else{
                                    ...
                                    <div class="col-md-4">
                                        <div class="card bg-light">
                                            ...
                                            try {
                                                ...
                                                // Count the number of classes the teacher handles
                                                ...
                                                // Get the meeting_id from 'classes_meetings' for each class and calculate attendance
                                                ...
                                                foreach ($classes as $class) {
                                                    ...
                                                    if ($activities) {
                                                        ...
                                                        foreach ($activities as $activity) {
                                                            ...
                                                            // If there are graded submissions, increment pending activities
                                                            if ($graded_count == 0) {
...
");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            ...
                                                            <a
                                                                href="class_grades.php?class_id=<?= urlencode($class['id']) ?>&semester_id=<?= urlencode($class['semester_id']) ?>">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createClassModal"><i
