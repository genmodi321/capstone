...
<head>
    ...
    <link href="external/css/student_dashboard.css" rel="stylesheet">
    ...
    <div class="container-fluid whole-container">
        <div class="row">
            ...
            <div class="col-md-2 sidebar text-center">
                ...
                <img src="https://i.pinimg.com/736x/79/5f/6a/795f6a68557b26980f241deb6dd7d452.jpg"
                    class="img-fluid logo space-sm">
                <h5 class="bold">Welcome, Student!</h5>
                ...
                <div class="navigation-links" style="text-align: left;">
                    ...
                    <span><i class="bi bi-menu-button-wide"></i>
                        Management</span>
                    <a href="" data-bs-toggle="collapse" data-bs-target="#subjects">
                        <p><i class="bi bi-book"></i> Subjects
                        </p>
                    </a>
                    <a data-bs-toggle="collapse" data-bs-target="#activities">
                        <p><i class="bi bi-journals"></i> Activities
                        </p>
                    </a>
                    <hr>

                    <div class="btn-group dropup">
                        <p class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i
                                class="bi bi-calendar-event"></i>
                            Profile</p>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                    data-bs-target="#updateProfileModal">Update
                                    Profile</a></li>
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                    data-bs-target="#updatePasswordModal">Change
                                    Password</a></li>
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                    data-bs-target="#updateCourseYearModal">Update
                                    Course & Year</a></li>
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                    data-bs-target="#updateProfilePictureModal">Update
                                    Profile Picture</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="index.html">Log
                                    Out</a></li>
                        </ul>
                    </div>
            ...
            <div class="col">
                ...
                <div class="container-fluid d-flex navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="ms-auto">
                            <span class="ms-auto">
                                <a href class="nav-link-spand position-relative " data-bs-toggle="modal"
                                    data-bs-target="#messageModal">

                                    <i class="bi bi-chat-dots iconics"></i>
                                ...
                                <a class="nav-link-span position-relative"><i class="bi bi-bell iconics"
                ...
                <div class="container-fluid actual-content">
                    <div class="container wd-75">
                            ...
                            <div class="d-flex align-items-center">
                                <h3>Welcome to your Dashboard!
                                    ...
                                    <p class="fs-small mt-10">Welcome back!
                                        Here's
                                        to another day of studying and
                                        working hard
                                        to be succesful!</p>
                                    <p class="fs-small mt-10">Home / <a href="student_dashboard.html"
                                            class="nav-ham-link">Index</a> </p>
                                </h3>

                                <div class="ms-auto" aria-hidden="true">
                                    <img src="external/svgs/undraw_teacher.svg" class=" small-picture img-fluid">
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row text-center">
                            <div class="col container-bordered" data-bs-toggle="modal" data-bs-target="#subjectsModal">
                                <h5>No. of Subjects (2)</h5>
                                <ul>
                                    <li>Capstone 1 and Research</li>
                            ...
                            <div class="col container-bordered" data-bs-toggle="modal"
                                ...
                                <ul>
                                    <li>Activity 2: Host your Website (Due
                                        on 8/19/2024)</li>
                            ...
                            <div class="col container-bordered" data-bs-toggle="modal"
                                data-bs-target="#missedActivitiesModal">
                                <h5>Missed Activities</h5>
                                <ul>
                                    <li class="missed">Activity 1: Make a
                                        Website</li>
                                </ul>

                            </div>

                            <div class="col container-bordered">
                                <h5>Student QR Code</h5>

                                <img src="<?php echo htmlspecialchars($student['qr_code']); ?>"
                                    class="img-fluid qr-code" alt="Student QR Code" data-bs-toggle="modal"
                        ...
                        <div class="row text-center d-flex justify-content-center">
                            ...
                            <div class="col-sm-2 container-bordered  cb-hover" data-bs-toggle="modal"
                        ...
                        <div class="accordion" id="shortcutLinks">
                            <div class="container-fluid accordion-collapse collapse bordered" id="info"
                                ...
                                <div class="accordion-body">
                                    <p class="text-center bold">Personal
                                        Information</p>
                                    <br>
                                    <p><strong>Full Name:</strong> John
                                        Doe</p>
                                    <p><strong>Email:</strong>
                                        johndoe@example.com</p>
                                    <p><strong>Course & Year:</strong>
                                        Bachelor
                                        of Science in Computer Science, 3rd
                                        Year</p>
                                    <p><strong>Address:</strong> 123 Main
                                        Street, Cityville</p>
                                    <p><strong>Phone Number:</strong> +123
                                        456
                                        7890</p>
                                            ...
                                            <div class="ms-auto">
                                                <form>
                                                    <input type="text" class="form-control" name="search"
                                                        placeholder="Enter class name / code here">
                                                </form>
                                            </div>
                                        </div>
                                            ...
                                            <?php foreach ($classes as $class): ?>
                                                <div class="col">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h5 class="card-title">
                                                                <?php echo htmlspecialchars($class['name']); ?></h5>
                                                            <p class="card-text">
                                                                <?php echo htmlspecialchars($class['subject']); ?></p>
                                                            <p class="card-text">Teacher:
                                                                <?php echo htmlspecialchars($class['teacher']); ?></p>
                                                            <p class="card-text">Class Code:
                                                                <?php echo htmlspecialchars($class['classCode']); ?></p>
                            ...
                            <div class="container-fluid accordion-collapse collapse bordered" id="activities"
                                data-bs-parent="#shortcutLinks">
                                <div class="accordion-body">
                                    <h5>Subject: Capstone 1 & Research</h5>
                                    <p>Activities List:</p>
                                    <ul>
                                        <li>Activity 1: Create a Prototype</li>
                                        <li>Activity 2: Create your chapter 2 and 3</li>
                                    </ul>
                                    <p>
                                        <a href="student_classes.html#activity" class="btn btn-primary">View Details</a>
                                    </p>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row msg align-items-center" data-bs-target="#actualMessageModal" data-bs-toggle="modal">
                    ...
                    <div class="col">
                        <p><em>You: Sure sir Catadman. I will work
                                on
                                that
                                right
                                now.</em></p>
                ...
                <div class="row unread msg align-items-center">
                    ...
                    <div class="col">
                        <p><em>Lorenzo: Good afternoon sir, ask ko
                                lang
                                if
                                available po
                                si...</em></p>
            ...
            <div class="modal-body" id="chatBody">
                ...
                <div class="row sender">
                    <div class="col">
                        ...
                        <div class="message">
                            <span>Hi, this is Jason Catadman. I'd
                                like
                                to
                                switch from Web
                ...
                <div class="row receiver">
                    <div class="col">
                        <div class="message">
                            <span>Sure sir Catadman. I will work on
                                that
                                right now.</span>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-auto" aria-hidden="true">
                        <a href class="nav-ham-link" data-bs-toggle="modal" data-bs-target="#addNotesModal">Add New
                            Note</a>
                    </div>
                </div>
                <br>
                ...
                <div class="container-fluid">
                    <div class="accordion" id="reminderOne">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <p>Pass documentary requirements
                                        <br>
                                        Due at: 11:59PM
                                        8/11/2024
                                    </p>
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#reminderOne">
                                <div class="accordion-body">
                                    <p>Pass the documentary
                                        requirements
                                        to
                                        the registrar.</p>
                                </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#reiminderTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    <p>Pass documentary requirements
                                        <br>
                                        Due at: 11:59PM
                                        8/13/2024
                            ...
                            <div id="reiminderTwo" class="accordion-collapse collapse" data-bs-parent="#reiminderTwo">
                                <div class="accordion-body">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#reiminderThree" aria-expanded="false" aria-controls="collapseTwo">
                                    <p>Consult a technical HR
                                        meeting
                                        <br>
                                        Due at: 4:00PM
                                        8/14/2024
            ...
            <div class="modal-body">
                <div class="form-container">
                    <form>
                        ...
                        <input type="address" class="input-form"><br>
                        <label>Mobile Number:</label> <br>
                        <input type="text" class="input-form" value="+63"> <br>
                        <label>Emergency Number:</label> <br>
                        <input type="text" class="input-form" value="+63"> <br>
                        <label>Gender:</label> <br>
                        <select class="input-form"><br>
                            <option value="Male"> Male </option>
                            <option value="Female"> Female </option>
                            <option value="Rather not Say"> Rather
                                not Say </option>
                        </select> <br> <br>
            ...
            <div class="modal-body">
                <div class="form-container">
                    <form>
                        ...
                        <input type="password" class="input-form" id="oldPassword" placeholder="Enter old password">
                        <input type="checkbox" onclick="togglePasswordVisibility('oldPassword')">
                        Show Password
                        <br><br>

                        <label>New Password:</label> <br>
                        <input type="password" class="input-form" id="newPassword" placeholder="Enter new password">
                        <input type="checkbox" onclick="togglePasswordVisibility('newPassword')">
                        Show Password
                        <br><br>

                        <label>Re-enter New Password:</label> <br>
                        <input type="password" class="input-form" id="reenterPassword"
                            placeholder="Re-enter new password">
                        <input type="checkbox" onclick="togglePasswordVisibility('reenterPassword')">
                        Show Password
                        <br><br>
...
<div class="modal fade" id="updateCourseYearModal" tabindex="-1" aria-labelledby="updateCourseYearLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="updateCourseYearLabel">Update Course &
                    Year</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="courseYearForm">
                    <div class="mb-3">
                        <label for="courseInput" class="form-label">Course</label>
                        <input type="text" class="form-control" id="courseInput" placeholder="Enter your course">
                    </div>
                    <div class="mb-3">
                        <label for="yearLevelInput" class="form-label">Year Level</label>
                        <select class="form-select" id="yearLevelInput">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="saveCourseYear()">Save changes</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="updateProfilePictureModal" tabindex="-1" aria-labelledby="updateProfilePictureLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="updateProfilePictureLabel">Update Profile
                    Picture</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="profilePictureForm">
                    <div class="mb-3">
                        <label for="profilePictureInput" class="form-label">Upload New Profile
                            Picture</label>
                        <input type="file" class="form-control" id="profilePictureInput" accept="image/*">
                    </div>

                    <div class="row">
                        <div class="col text-center  d-flex justify-content-center flex-column align-items-center ">
                            <h5>Previous Profile Picture</h5>
                            <img id="previousProfilePicture"
                                src="https://i.pinimg.com/736x/79/5f/6a/795f6a68557b26980f241deb6dd7d452.jpg"
                                alt="Previous Profile Picture" class="img-fluid rounded-circle"
                                style="max-width: 75px;">
                        </div>
                        <div class="col text-center  d-flex justify-content-center flex-column align-items-center ">
                            <h5>New Profile Picture Preview</h5>
                            <img id="profilePicturePreview" src="#" alt="Profile Picture Preview"
                                class="img-fluid rounded-circle" style="max-width: 75px; display: none;">
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary">Reset Picture</button>
                <button type="button" class="btn btn-primary" onclick="saveProfilePicture()">Save
                    changes</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="subjectsModal" tabindex="-1" aria-labelledby="subjectsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="subjectsModalLabel">No. of Subjects</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <ul>
...
<div class="modal fade" id="pendingActivitiesModal" tabindex="-1" aria-labelledby="pendingActivitiesModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <ul>
                    <li>Activity 2: Host your Website (Due on 8/19/2024)</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="missedActivitiesModal" tabindex="-1" aria-labelledby="missedActivitiesModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="missedActivitiesModalLabel">Missed Activities</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <ul>
                    <li class="missed">Activity 1: Make a Website</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="<?php echo htmlspecialchars($student['qr_code']); ?>" class="img-fluid" alt="Student QR Code">
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="gradesModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Grades</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="subject-title bold">Subject Code: IT 01<br>Course: Capstone 1 & Research</div>
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="criteria">Quizzes (30%)</td>
                                        <td>15/20</td>
                                        <td>18/20</td>
                                        <td>20/20</td>
                                        <td>16/20</td>
                                        <td>17/25</td>
                                        <td>20/25</td>
                                        <td class="total-column">83%</td>
                                    </tr>
                                    <tr>
                                        <td class="criteria">Activities (20%)</td>
                                        <td>18/20</td>
                                        <td>19/20</td>
                                        <td>20/20</td>
                                        <td>17/20</td>
                                        <td>17/20</td>
                                        <td>16/20</td>
                                        <td colspan="2" class="total-column">90%</td>
                                    </tr>
                                    <tr>
                                        <td class="criteria">Project Based (30%)</td>
                                        <td>28/30</td>
                                        <td>27/30</td>
                                        <td>29/30</td>
                                        <td>25/30</td>
                                        <td>26/30</td>
                                        <td>30/30</td>
                                        <td class="total-column">93%</td>
                                    </tr>
                                    <tr>
                                        <td class="criteria">Midterms (15%)</td>
                                        <td>13/15</td>
                                        <td>12/15</td>
                                        <td>14/15</td>
                                        <td>13/15</td>
                                        <td>12/15</td>
                                        <td>14/15</td>
                                        <td class="total-column">87%</td>
                                    </tr>
                                    <tr>
                                        <td class="criteria">Finals (5%)</td>
                                        <td>4/5</td>
                                        <td>5/5</td>
                                        <td>4.5/5</td>
                                        <td>4/5</td>
                                        <td>4/5</td>
                                        <td>5/5</td>
                                        <td class="total-column">91%</td>
                                    </tr>
                                    <tr>
                                        <td class="criteria">Total Average</td>
                                        <td colspan="6"></td>
                        ...
                        <div class="col-md-6">
                            <div class="subject-title bold">Subject Code: IT 02<br>Course: Software Engineering</div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Criteria</th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="subject-title bold">Subject Code: IT 03<br>Course: Advanced Database</div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Criteria</th>
                        ...
                        <div class="col-md-6">
                            <div class="subject-title bold">Subject Code: IT 04<br>Course: Networking</div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Criteria</th>
