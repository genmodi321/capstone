...
<html lang="en">
  <head>
    ...
    <link
      href="external/css/teacher_dashboard.css"
      rel="stylesheet">
            ...
            <div class="row">
              <div class="col">
                <div class="d-flex align-items-center">
                  <h5>Subjects</h5>
                  <div class="ms-auto" aria-hidden="true">
                    <a href class="btn btn-danger" onclick="viewAll()"><i
              ...
              <div class="col">
                ...
                <div class="row info-container">
                  ...
                  <ul>
                    <li><a href>Activity #1: Make a Portfolio</a></li>
                    <li><a href>Activity #2: Make a Website</a></li>
                  </ul>
                </div>
