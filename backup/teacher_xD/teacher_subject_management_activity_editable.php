...
<head>
  ...
  <link
    href="external/css/teacher_subjects_activity.css"
    rel="stylesheet">
      ...
      <div class="col">
        ...
        <div class="container-fluid actual-content">
          <div class="container wd-75">
            ...
            <hr>
            <div class="container">
              <a href="teacher_subject_management_activity_dashboard.php?id=<?php echo $_GET['subject_id'] ?>" class="nav-ham-link">
                <h5><i class="bi bi-arrow-left"></i> Back</h5>
              </a>
            </div>
            ...
            <div class="container">
              ...
              // Initialize variables to store assessment data
              $title = $description = $dueDate = $dueTime = $points = $passingPoints = $assessmentType = $attachment = "";

              // Fetch data from the assessments table if the 'id' is provided
              if ($assessment_id) {
                try {
                  ...
                  if ($assessment) {
                    // Assign the assessment data to variables
                    $title = $assessment['name'];
                    $description = $assessment['description'];
                    $dueDate = $assessment['due_date'];
                    $dueTime = $assessment['due_time'];
                    $points = $assessment['max_points'];
                    $passingPoints = $assessment['passing_points'];
                    $assessmentType = $assessment['type'];
                    $attachment = $assessment['attachment'];
                  }
                } catch (PDOException $e) {
                  echo "Error fetching assessment: " . $e->getMessage();
                }
              }
              ?>

              <!-- HTML form with data pre-filled using PHP -->
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-6">
                    <form id="uploadForm" enctype="multipart/form-data" method="POST" action="processes/teachers/assessments/edit.php?id=<?php echo $assessment_id; ?>&subject_id=<?php echo $_GET['subject_id'] ?>">
                      <label>Title:</label>
                      <input type="text" name="title" class="input-form" placeholder="Insert a Title" value="<?php echo htmlspecialchars($title); ?>">

                      <textarea rows="15" class="textarea" placeholder="Write a description for particular activity" name="description"><?php echo htmlspecialchars($description); ?></textarea>
                      <br>
                      ...
                      <?php if ($attachment): ?>
                        <ul id="fileList">
                          <li>
                            Current Attachment:
                            <a href="../uploads/files/<?php echo htmlspecialchars($attachment); ?>" target="_blank" style="color:black !important">
                              <?php echo htmlspecialchars($attachment); ?>
                            </a>
                            <a href="processes/teachers/assessments/file_delete.php?id=<?php echo $_GET['id'] ?>"><i class="bi bi-trash-fill" style="color:red !important"></i></a>
                  ...
                  <div class="col">
                    ...
                    <input class="input-form" type="date" name="dueDate" value="<?php echo htmlspecialchars($dueDate); ?>"> <br> <br>

                    <label>Due Time: </label> <br>
                    <input class="input-form" type="time" name="dueTime" value="<?php echo htmlspecialchars($dueTime); ?>"> <br> <br>

                    <label>Points: </label> <br>
                    <input class="input-form" type="number" minlength="1" name="points" value="<?php echo htmlspecialchars($points); ?>"> <br> <br>

                    <label>Passing Points: </label> <br>
                    <input class="input-form" type="number" minlength="1" name="passingPoints" value="<?php echo htmlspecialchars($passingPoints); ?>"> <br> <br>

                    <label>Activity: </label> <br>
                    <select class="input-form" name="assessment_type">
                      <option value="Quiz" <?php echo ($assessmentType === 'Quiz') ? 'selected' : ''; ?>>Quiz</option>
                      <option value="Activity" <?php echo ($assessmentType === 'Activity') ? 'selected' : ''; ?>>Activity</option>
                      <option value="Project" <?php echo ($assessmentType === 'Project') ? 'selected' : ''; ?>>Project</option>
                    </select>
                    <br> <br>
                  </div>
                </div>
                ...
                <div class="text-center">
                  <button class="btn btn-csms">Cancel</button>
                  <input type="submit" value="Save" class="btn btn-csms">
                </div>
                </form>
              </div>
...
<script>
  ...
  function gotoAttendance() {
    window.location.href = "teacher_class_attendance.html";
  }
