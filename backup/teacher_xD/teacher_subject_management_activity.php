                  ...
                  <div class="row">
                    ...
                    <form id="uploadForm"  enctype="multipart/form-data" method="POST" action="processes/teachers/assessments/add.php?id=<?php echo $_GET['id']?>">
                      ...
                      <div class="col">
                        ...
                        <input class="input-form" type="date" name="dueDate"> <br> <br>

                        <label>Due Time: </label> <br>
                        <input class="input-form" type="time" name="dueTime"> <br> <br>

                        <label>Points: </label> <br>
                        <input class="input-form" type="number" minlength="1" name="points" value=1> <br> <br>
