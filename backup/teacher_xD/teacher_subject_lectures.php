...
<head>
  ...
  <link
    href="external/css/teacher_subjects_lectures.css"
    rel="stylesheet">
      ...
      <div class="col">
        ...
        <div class="container-fluid actual-content">
          <div class="container wd-75">
                  ...
                  <p class="fs-small mt-10"> <a
                    ...
                    <a
                      ...
                      class="nav-ham-link"><?php
                                            ...
                                            ?></span> /
                    <span
                      class="nav-ham-link">Lectures</span>
                  </p>
                </h3>
            ...
            <div class="container">
              <div class="d-flex align-items-center">
                ...
                <div class="ms-auto text-center">
                  <button class="btn btn-csms" data-bs-target="#addResourceModal" data-bs-toggle="modal"> <i class="bi bi-plus-circle-fill"></i> Add New Resource</button>
                </div>
              </div>
            ...
            <?php
            $subject_id = $_GET['id']; // Getting subject_id from the GET parameter
            ...
            <div class="container-fluid">
              <?php if (empty($lectures)): ?>
                <h1 class="text-center">
                  No lessons or resources uploaded.
                </h1>
              <?php else: ?>
                <?php foreach ($lectures as $lecture): ?>
                  <div class="container-fluid file-container">
                    <div class="row align-items-center"> <!-- Align items to center -->
                      <div class="col-sm-1 text-center">
                        <?php
                        // Display different icons based on the file type
                        if ($lecture['type'] === 'pdf'): ?>
                          <h1 class="bi bi-file-pdf" style="font-size:64px;"></h1>
                        <?php elseif ($lecture['type'] === 'docx'): ?>
                          <h1 class="bi bi-file-earmark-word" style="font-size:64px;"></h1>
                        <?php elseif ($lecture['type'] === 'ppt'): ?>
                          <h1 class="bi bi-file-earmark-slides" style="font-size:64px;"></h1>
                        <?php elseif ($lecture['type'] === 'mp4'): ?>
                          <h1 class="bi bi-camera-video" style="font-size:64px;"></h1>
                        <?php else: ?>
                          <h1 class="bi bi-file-earmark" style="font-size:64px;"></h1>
                        <?php endif; ?>
                      </div>
                      <div class="col">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="ms-auto text-center">
                            <p class="bold"><?php echo date('m/d/Y', strtotime($lecture['date'])); ?></p>
                            <a download="<?php echo htmlspecialchars($lecture['file']); ?>"
                              href="../uploads/files/<?php echo htmlspecialchars($lecture['file']); ?>"
                              style="color: black !important">
                              <h5 class="bi bi-download bold"></h5>
                            </a>
                          </div>
                        </div>
                      </div>
...
<div class="modal fade" id="addResourceModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Upload a New Learning Material</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="uploadResourceForm" enctype="multipart/form-data" method="POST" action="processes/teachers/lessons/add.php?id=<?php echo $_GET['id'] ?>">
          <div class="mb-3">
            <label for="title" class="form-label">Title:</label>
            <input type="text" class="form-control" name="title" id="title" placeholder="Enter resource title" required>
          </div>

          <div class="mb-3">
            <label for="resourceFile" class="form-label">Upload File:</label>
            <input type="file" class="form-control" name="resourceFile" id="resourceFile" accept=".pdf,.doc,.docx,.ppt,.pptx,.mp4,.zip" required>
          </div>
