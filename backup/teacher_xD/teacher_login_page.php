...
<body>
    ...
    <div class="container-fluid login-container">
        ...
        <div class="actual-login-container">
            ...
            <h5 class="bold">STAFF LOGIN</h5>

            <div class="container login-container-with-input">
                <form action="processes/teachers/account/login.php" method="POST">
                    <label style="text-align: left !important;"
                        class="bold">EMAIL</label>
                    <input class="form-control" name="username_email" type="email"
            ...
            <div class="button-linkers d-flex justify-content-between">
                <a href="staff_create_account.php" class="gb-link me-auto" class="gb">Create an Account</a>
