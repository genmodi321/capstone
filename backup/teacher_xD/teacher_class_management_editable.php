        ...
        <div class="col">
          ...
          <div class="container-fluid actual-content">
            <div class="container wd-75">
              ...
              <div class="row">
                <div class="d-flex align-items-center">
                  <button class="btn btn-csms"  onclick="gotoAttendance()"><i
                      class="bi bi-file-binary-fill"></i> Attendance</button>
                  &nbsp;
                  <button class="btn btn-csms"><i class="bi bi-pen-fill"></i>
                    Rubrics</button>
                  &nbsp;
                  <button class="btn btn-csms"> <i class="bi bi-code"></i>
                    Criteria</button>
              ...
              <div id="printTable">
                ...
                <div class="row">
                  <div class="col">
                    <span><b>Adviser:</b> Mr. Jason C. Catadman</span>
                  </div>
                  <div class="col">
                    <span><b>Semester:</b> First Semester</span>
                  </div>
                </div>

                <div class="row">
                  <div class="col">
                    <span><b>Subject:</b> Capstone 1 & Research</span>
                  </div>
                  <div class="col">
                ...
                <div class="row">
                  <div class="col">
                    <span><b>Year and Section:</b> BSIT - 4A</span>
                  </div>
                </div>
                  ...
                  <thead style="border: 1px solid black;">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <input type="number" value="15" class="inputter">
                      </td>
                      <td class="text-center">
                        <input type="number" value="15" class="inputter">
                      </td>
                    ...
                    <div class="row">
                      <div class="d-flex align-items-center">
                        <button class="btn btn-csms" onclick="goBack()"><i
                      ...
                      <button class="btn btn-csms" onclick="goBack()"> <i
                        ...
                        <div class="ms-auto" aria-hidden="true">
                          <div class="btn btn-secondary">Class Code: <br>
                            SOF123DXA</div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="row unread msg align-items-center">
                    ...
                    <div class="col">
                      <p><em>Lorenzo: Good afternoon sir, ask ko lang if
                          available
                          po
                          si...</em></p>
                    </div>
                ...
                <div class="modal-body" id="chatBody">
                  ...
                  <div class="row sender">
                    <div class="col">
                      ...
                      <div class="message">
                        <span>Hi, this is Jason Catadman. I'd like to switch
                          from
                          Web
                      ...
                      <div class="accordion-item">
                        ...
                        <div id="collapseTwo"
                          ...
                          <div class="accordion-body">
                            ...
                            <p><em>Look towards creating a grandiose
                                life.</em></p>
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          <button class="accordion-button collapsed"
                            ...
                            aria-expanded="false" aria-controls="collapseTwo">
                            <p>Pass documentary requirements <br> Due at:
                              11:59PM
                              8/13/2024</p> &nbsp; &nbsp; <span
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          <button class="accordion-button collapsed"
                            ...
                            aria-expanded="false" aria-controls="collapseTwo">
                            <p>Consult a technical HR meeting <br> Due at:
                              4:00PM
                              8/14/2024</p> &nbsp; &nbsp; <span
