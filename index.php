        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid d-flex">
                ...
                <div class="collapse navbar-collapse"
                    ...
                    <div class="ms-auto">
                        <span class="ms-auto">
                            <a href="index.html" class="nav-link-span">Home</a>
                            <a href="about_us.html" class="nav-link-span">About</a>
                            <a href="contact_us.html" class="nav-link-span">Contact Us</a>
                            <a href="contact_us.html#faq" class="nav-link-span">Help</a>
                            <a href="admin_login_page.php" ><i class="bi bi-person-fill-gear icon" style="color:white"></i></a>
                        </span>
    ...
    <body>
        ...
        <div class="container-fluid main-container">
            ...
            <div class="container link-container">
                <a href="student/student_login_page.php" class="navigation-link">
                    <img src="external/img/wmsu_Logo-removebg-preview.png"
                        class="img-fluid big-logo">
                    <h5 class="bold">STUDENT</h5>
                </a>
                <a href="teacher/teacher_login_page.php" class="navigation-link">
                    <img src="external/img/ccs_logo-removebg-preview.png"
                        class="img-fluid big-logo">
                    <h5 class="bold">TEACHER</h5>
                </a>
            </div>
        </div>
