...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            if ($class_id) {
                ...
                try {
                    ...
                    $stmt = $pdo->prepare("
            SELECT c.name AS class_name, c.teacher, s.type AS subject_type, ss.start_time, ss.end_time, ss.meeting_days, c.subject
            FROM classes c
                    ...
                    <div class="container-fluid actual-content">
                        <div class="container-fluid">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <h3 class="bold">&nbsp;<?php echo $subjectName ?></h3>
                        ...
                        <div class="container-fluid">
                            <div class="row text-center">
                                ...
                                <div class="col linkism">
                                    <div class="dropdown">
                                        <button class="btn wide-btn btn-csms-1" href="#" role="button"
                                            data-bs-toggle="collapse" data-bs-target="#grades" aria-expanded="true"
                                            aria-controls="students" aria-expanded="false">
                                            Grades
                                        </button>
                                ...
                                <div class="col linkism">
                                    <button class="btn wide-btn btn-csms-1" onclick="goToLectures()"
                                        data-bs-toggle="collapse" data-bs-target="#lectures" aria-expanded="false"
                            ...
                            <div class="accordion" id="navlinkers">
                                <div id="students" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <div class="container">
                                            ...
                                            <div class=" bordered-none align-middle teacher-container-individual">
                                ...
                                <div id="activity" class="accordion-collapse collapse" data-bs-parent="#navlinkers">
                                    <?php
        ...
        ");
                                    ...
                                    <div class="accordion-body">
                                        <h5 style="font-weight: bold; color: #5b8b5e;">Activities</h5>
                                        <ul class="list-unstyled">
                                            <?php if (!empty($activities)): ?>
                                                ...
                                                ");
                                                            ...
                                                            <div class="ms-auto text-end">
                                                                ...
                                                                <p class="mb-0"
                                                                    ...
                                                                    if ($submission['status'] == 'graded') {
                                                                        ...
                                                                        // Display "Passed" in a small alert beside the score
                                                                        echo '<span class="alert alert-warning d-inline-block mb-0" style="font-size: 12px; padding: 2px 6px; margin-right: 5px;">No submissions yet</span>';
                                                                        echo "Score: ";
                                                                        echo $submission['score'] . ' ';
                                                                    }
                                                                    ?>
                                                                    </span> /
                                                                    <?php echo htmlspecialchars($activity['max_points']); ?> pts
                                                                </p>
                                                    ...
                                                    <div class="modal fade" id="activityModal<?php echo $activity['id']; ?>"
                                                        tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <?php if (!empty($attachments)): ?>
                                                                        <ul>
                                                                            <?php foreach ($attachments as $attachment): ?>
                                                                                <li>
                                                                                    <a href="capstone/uploads/files/<?php echo htmlspecialchars($attachment['file_path']); ?>"
                                                                                        target="_blank">
                                                                    ...
                                                                    <?php else: ?>
                                                                        <p class="text-muted">No attachments available for this
                                                                            activity.</p>
                                                                    <?php endif; ?>
                                                                    ...
                                                                    <br>
                                                                    <p>
                                                                        <small>Submission: If your teacher hasn't prompted you
                                                                        ...
                                                                        <form method="POST"
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label
                                                                                    ...
                                                                                    class="form-label">Upload Your File</label>
                                            ...
                                            <?php else: ?>
                                                <li>
                                                    <p style="font-size: 16px; color: #6c757d;">No activities available for
                                                        this class.</p>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
            ...
            ");
                ...
                ");
                            ...
                            ");
                                                                ...
                                                                echo '<td><span class="' . $badge_class . '">' . strtoupper($status) . '</span></td>';
                                ...
                                <div id="lectures" class="accordion-collapse collapse" data-bs-parent="#navlinkers">
                                    <div class="accordion-body">
                                        ...
                                        if ($class_id) {
                                            try {
                                                // Fetch learning resources for the given class_id
                                                $stmt = $pdo->prepare("
                ...
                ");
                                                ...
                                                if ($resources) {
                                                    // Loop through each resource and display accordingly
                                                    foreach ($resources as $resource) {
                                                        // Extract the resource data
                                                        $resource_name = htmlspecialchars($resource['resource_name']);
                                                        $resource_type = htmlspecialchars($resource['resource_type']);
                                                        $uploaded_at = date('F j, Y', strtotime($resource['uploaded_at']));  // Format the uploaded date
                                                        ...
                                                        switch ($resource_type) {
                                                            ...
                                                            default:
                                                                $icon = 'bi bi-file-earmark'; // Default fallback icon
                                                        }

                                                        // Start displaying the resource
                                                        echo '<div class="container file-container">';
                                                        ...
                                                        echo '        <div>';
                                                        echo '          <h5 class="bold">' . $resource_name . '</h5>';
                                                        echo '          <p><strong>Type:</strong> ' . $resource_type . '</p>';
                                                        echo '          <p><strong>Description:</strong> ' . $resource_description . '</p>';
                                                        echo '        </div>';
                                                        echo '        <div class="ms-auto text-center">';
                                                        echo '          <p class="bold">' . $uploaded_at . '</p>';
                                                        // Check if resource is downloadable (i.e., URL exists)
                                                        if ($resource_url) {
                                                            echo '          <a download="' . basename($resource_url) . '" href="' . $resource_url . '" style="color: black !important">';
            ...
            ");
                                            ...
                                            if ($stmtClasses->rowCount() > 0) {
                                                ...
                                                // Fetch attendance data for each class the student is enrolled in
                                                while ($row = $stmtClasses->fetch(PDO::FETCH_ASSOC)) {
                                                    ...
                                                    // Query to get attendance records for the current student and class
                    ...
                    ");
                                                    $stmtAttendance->execute([':student_id' => $studentId, ':class_id' => $classId]);

                                                    // Display the attendance for each class
                        ...
                        <div class="row text-center d-flex justify-content-center">
                            ...
                            <div class="col-sm-2 container-bordered  cb-hover" data-bs-toggle="collapse"
                                data-bs-target="#attendance_part">
                                Attendance
                            </div>

                            <div class="col-sm-2 container-bordered  cb-hover" data-bs-toggle="collapse"
                                data-bs-target="#grades_part">
                                Grades
                            </div>
                        </div>
                        ...
                        if (isset($_SESSION['student_id'])) {
                            ...
                            if (!$studentInfo) {
                                // Handle the error, such as redirecting to another page
                ...
                WHERE e.student_id = :student_id");
                            ...
                            <div class="container-fluid accordion-collapse collapse bordered" id="attendance_part"
                                data-bs-parent="#shortcutLinks">
                                <div class="accordion-body">
                                    <?php
                                    // Include the database connection
        ...
        ");
                            ...
                            <div class="container-fluid accordion-collapse collapse bordered" id="grades_part"
                                data-bs-parent="#shortcutLinks">
                                <div class="accordion-body">
                                    <?php
                                    // Include the database connection
