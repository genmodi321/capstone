...
INSERT INTO `activities` (`id`, `title`, `type`, `message`, `due_date`, `due_time`, `min_points`, `max_points`, `class_id`, `subject_id`, `created_at`, `updated_at`) VALUES
(5, 'test', 'quiz', 'asdasdas', '2222-02-22', '02:52AM', 25, 25, 64, 42, '2024-11-02 15:58:30', '2024-11-02 15:58:30'),
(6, 'MEMORANDUM OF AGREEMENTS', 'quiz', 'wwoww', '2024-11-03', '14:22', 25, 100, 64, 42, '2024-11-02 15:59:22', '2024-11-02 23:50:24'),
(7, 'test', 'quiz', 'test', '2024-12-01', '02:55PM', 10, 50, 64, 43, '2024-11-30 16:45:30', '2024-11-30 16:45:30'),
(8, 'tester', 'quiz', 'test', '2024-12-08', '04:30AM', 25, 50, 64, 43, '2024-12-07 12:29:47', '2024-12-07 12:29:47'),
(9, 'testerhaha', 'quiz', 'test', '2024-12-08', '04:30AM', 25, 50, 64, 43, '2024-12-07 12:29:53', '2024-12-07 12:29:53'),
(10, 'mama', 'quiz', 'meme', '2024-12-09', '02:55PM', 10, 50, 64, 43, '2024-12-07 12:30:52', '2024-12-07 12:30:52');
...
(4, 7, 'Mock-Defense-Final-Docu.pdf', 'uploads/674ba39ac1b85-Mock-Defense-Final-Docu.pdf', '2024-12-01 00:45:30');
...
(11, 'admin_ccs', 'admin_ccs@wmsu.com', '$2y$10$wpEG6wnmQVbA2OTEFlCOJOMRuoFSq2kW4yzoR7FrIxF9UwNqg1oqG', 'Lucas', 'Alexander', 'Mitchell', '2024-09-22', '2024-12-08 02:04:49', '+639123456789', 'Male');
...
(43, 'Software Engineering', 'Lecture', 'IT - 141', '1st Semester', '2024-11-30 14:34:15', 1, 'BSIT', '1A'),
(44, 'Introduction to Computing', 'Lecture', 'IT - 141', '1st Semester', '2024-11-30 14:34:15', 1, 'BSIT', '1A');
...
--
ALTER TABLE `activity_submissions`
  ADD CONSTRAINT `activity_submissions_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`id`),
  ADD CONSTRAINT `activity_submissions_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`);
