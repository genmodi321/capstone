						...
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<table id="adminTable" class="display table table-striped" cellspacing="0"
										width="100%">
										<thead>
											<tr>
												<th>Username</th>
										...
										<tbody>
											<?php foreach ($admins as $admin): ?>
												<tr>
													...
													<td>
														<!-- Actions like Edit, Delete, or View -->
...
<!-- Edit Modal -->
<div class="modal fade" id="editAdmin<?php echo $admin['id']; ?>" tabindex="-1" aria-labelledby="editAdminLabel<?php echo $admin['id']; ?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editAdminLabel<?php echo $admin['id']; ?>">Edit Admin</h5>
            ...
            <form action="processes/admin/account/edit.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="username<?php echo $admin['id']; ?>" name="username" value="<?php echo htmlspecialchars($admin['username']); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="email<?php echo $admin['id']; ?>" class="form-label">Email</label>
                        <input type="email" class="form-control" id="email<?php echo $admin['id']; ?>" name="email" value="<?php echo htmlspecialchars($admin['email']); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="first_name<?php echo $admin['id']; ?>" class="form-label">First Name</label>
                        <input type="text" class="form-control" id="first_name<?php echo $admin['id']; ?>" name="first_name" value="<?php echo htmlspecialchars($admin['first_name']); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="middle_name<?php echo $admin['id']; ?>" class="form-label">Middle Name</label>
                        <input type="text" class="form-control" id="middle_name<?php echo $admin['id']; ?>" name="middle_name" value="<?php echo htmlspecialchars($admin['middle_name']); ?>">
                    </div>

                    <div class="mb-3">
                        <label for="last_name<?php echo $admin['id']; ?>" class="form-label">Last Name</label>
                        <input type="text" class="form-control" id="last_name<?php echo $admin['id']; ?>" name="last_name" value="<?php echo htmlspecialchars($admin['last_name']); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="phone_number<?php echo $admin['id']; ?>" class="form-label">Phone Number</label>
                        <input type="text" class="form-control" id="phone_number<?php echo $admin['id']; ?>" name="phone_number" value="<?php echo htmlspecialchars($admin['phone_number']); ?>">
                    </div>

                    <div class="mb-3">
                        <label for="gender<?php echo $admin['id']; ?>" class="form-label">Gender</label>
                        <select class="form-select" id="gender<?php echo $admin['id']; ?>" name="gender" required>
                    ...
                    <div class="mb-3">
                        <label for="password<?php echo $admin['id']; ?>" class="form-label">Password</label>
                        <input type="password" class="form-control" id="password<?php echo $admin['id']; ?>" name="password">
                    </div>

                    <div class="mb-3">
                        <label for="confirm_password<?php echo $admin['id']; ?>" class="form-label">Confirm Password</label>
                        <input type="password" class="form-control" id="confirm_password<?php echo $admin['id']; ?>" name="confirm_password">
                    </div>
    ...
    function confirmDelete(adminId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Proceed with the deletion (send AJAX request or redirect)
