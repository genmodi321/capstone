...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $checkClassStmt->bindParam(':name', $subjectName, PDO::PARAM_STR);
        ...
        $stmt = $pdo->prepare("INSERT INTO classes (name, code, type, subject, teacher, semester, description, studentTotal, classCode, status) 
                               VALUES (:name, :code, :type, :subject, :teacher, :semester, :classDesc, 0, :classCode, :status)");
