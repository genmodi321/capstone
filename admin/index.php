								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<div class="card">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0" data-bs-toggle="modal" data-bs-target="#semesterModal">
									...
									<div class="row">
										<div class="col-sm-2">
											<div class="card">
												<div class="card-body text-center">
													...
													<div class="row">
														<div class="col">
															<a href="" class="nav-link-shortcut"><span class="nav-link-shortcut-text">Teachers</span></a>
															<br>
															<a href="" class="nav-link-shortcut"><span class="nav-link-shortcut-text">Subjects</span></a>
														</div>

														<div class="col mt-10">
															<a href="" class="nav-link-shortcut"><span class="nav-link-shortcut-text">Classes</span></a>
															<br>
															<a href="" class="nav-link-shortcut"><span class="nav-link-shortcut-text">Semester</span></a>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="col-sm">
											<div class="card">
												<div class="card-body text-center">
													<div class="row">
														<div class="col mt-0" data-bs-toggle="modal" data-bs-target="#notesModal">
										...
										<div class="col-sm">
											<div class="card">
												<div class="card-body text-center">
													<div class="row">
														<div class="col mt-0" data-bs-toggle="modal" data-bs-target="#remindersModal">
