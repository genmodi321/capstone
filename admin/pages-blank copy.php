													...
													?>
														...
														<script>
															document.getElementById('disapproveReasonSelect').addEventListener('change', function() {
																...
																if (this.value === 'Other') {
																	otherReasonDiv.style.display = 'block'; // Show the other reason textbox
																	otherReasonInput.setAttribute('required', 'required'); // Make it required
																} else {
																	otherReasonDiv.style.display = 'none'; // Hide the other reason textbox
							...
							<div class="mb-3">
								<div class="mb-3">
									<label class="form-label bold">
										Class Code:
										<button class="btn btn-primary copy-btn" style="padding: 3px; font-size: 12px;" onclick="copyText<?php echo $row['classCode'] ?>()">
											<i class="bi bi-clipboard-fill"></i>
										</button>
									</label>
									<p id="text-to-copy-<?php echo $row['classCode'] ?>"><?php echo htmlspecialchars($row['classCode']); ?></p>
								</div>
