          ...
          <div class="container wd-75">
              ...
              <div class="d-flex align-items-center">
                <h3>Welcome to your Dashboard!
                  ...
                  <p class="fs-small mt-10"> <a
                    ...
                    <span
                      class="nav-ham-link">Activity</span>
                  </p>
                </h3>
            ...
            <div class="container">
              <div class="container-fluid">
                ...
                <?php
                $subject_id = $_GET['id']; // Assuming subject_id is passed via GET

                try {
                  // Prepare the SQL query to fetch assessments for the specific subject
                  $sql = "SELECT * FROM assessments WHERE subject_id = :subject_id";
                  ...
                  if (!empty($assessments)) {
                    echo "   <h5>Here are the activities for the subject: </h5>";
            ...
            <div class='row subject-container'>
                <div class='d-flex align-items-center'>
                    <h5><i class='bi bi-book-fill'></i> Activity: " . htmlspecialchars($assessment['name']) . " </h5>
                    <div class='ms-auto' aria-hidden='true'>
                        <a href='teacher_subject_management_activity_editable.php?id={$assessment['id']}&subject_id={$_GET['id']}'>
                            <button class='btn btn-warning'><i class='bi bi-pen-fill'></i> Edit</button>
                        </a>
                        <button class='btn btn-danger'  onclick='confirmDelete(this)'  data-assessment-id='{$assessment['id']}'>
            ...
            ";
                    ...
                    echo "<h5 class='text-center'>No activities found yet for this subject.</h5>";
                  }
...
<div class="modal fade" id="deleteModal" tabindex="-1"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5"
          id="exampleModalLabel">Delete Activity</h1>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-csms"
          data-bs-dismiss="modal">Close</button>
        <form action="teacher_subject_management_activity_dashboard.html">
          <input type="submit" class="btn btn-csms" value="Delete"></button>
        </form>
      </div>
    </div>
  </div>
...
<script>
  function gotoAct(id) {
    window.location.href = "teacher_subject_management_activity.php?id=" + <?php echo $_GET['id']?>;
  }
    ...
    function confirmDelete(button) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Redirect or perform the delete action
                window.location.href = 'processes/teachers/assessments/delete.php?id=' + assessmentId + '&subjectId='  + <?php echo $_GET['id']?>;
            }
        });
    }
</script>
